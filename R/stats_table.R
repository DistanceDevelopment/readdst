...
#    ----- | -------------- | --------- | ---------------------------------------------------- | ------------
     ...
     2100  | K-S p          |  1e-6     | ddf.gof(model, qq=FALSE)$dsgof$ks$p                  | Goodness-of-fit Kolmogorov-Smirnov test probability
     2110  | C-vM p         |  1e-6     | ddf.gof(model, qq=FALSE)$dsgof$CvM$p                 | Goodness-of-fit Cramer-von Mises (uniform weighting) test probability
     ...
     4030  | NULL           |           | NULL                                                 | Number of individuals
     4031  | NULL           |           | NULL                                                 | Number of individuals analytic coeff. of var.
     4032  | NULL           |           | NULL                                                 | Number of individuals analytic lower conf. limit
     4033  | NULL           |           | NULL                                                 | Number of individuals analytic upper conf. limit
     4034  | NULL           |           | NULL                                                 | Number of individuals analytic degrees of freedom
